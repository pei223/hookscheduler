...
var (
	hookScheduleAllColumns            = []string{"hook_schedule_id", "hook_id", "display_name", "description", "schedule_interval_unit", "schedule_time_day", "schedule_time_hour", "schedule_time_minute", "schedule_time_second"}
	hookScheduleColumnsWithoutDefault = []string{"hook_schedule_id", "hook_id", "display_name", "description", "schedule_interval_unit", "schedule_time_day", "schedule_time_hour", "schedule_time_minute", "schedule_time_second"}
